...
import (
	...
	"github.com/MeshBoxFoundation/meshbox/internal/build"
	"strconv"
)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/MeshBoxFoundation/meshbox/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/MeshBoxFoundation/meshbox/mobile")
