...
import (
	...
	"github.com/MeshBoxFoundation/meshbox/eth/tracers/internal/tracers"
	"math/big"
	"strings"
	"sync/atomic"
	"time"
...
//func (jst *jsTracer) CaptureState(pc uint64, op vm.OpCode, gas, cost uint64, memory *vm.Memory, stack *vm.Stack, contract *vm.Contract, depth int, err error) error {
