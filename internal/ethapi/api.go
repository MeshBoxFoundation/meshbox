...
import (
	...
	"github.com/MeshBoxFoundation/meshbox/common/math"
	...
	"github.com/MeshBoxFoundation/meshbox/rlp"
	"github.com/MeshBoxFoundation/meshbox/rpc"
...
//
// https://github.com/MeshBoxFoundation/meshbox/wiki/Management-APIs#personal_sign
...
//
// https://github.com/MeshBoxFoundation/meshbox/wiki/Management-APIs#personal_ecRecover
...
func (s *PublicBlockChainAPI) _doCall(ctx context.Context, args CallArgs, vmCfg vm.Config, state *state.StateDB, header *types.Header) ([]byte, *big.Int, bool, error) {
	...
	res, gas, failed, err := core.ApplyMessage(evm, msg, gp, header.Number)
...
func (s *PublicBlockChainAPI) EstimateGas(ctx context.Context, args CallArgs) (*hexutil.Big, error) {
	...
	executable := func(gas uint64) bool {
		...
		_, _, failed, err := s.doCallWithNumber(ctx, args, rpc.PendingBlockNumber, vm.Config{})
		if err != nil || failed {
			return false
		}
		return true
