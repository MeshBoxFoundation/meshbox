...
func opSha3(pc *uint64, interpreter *Interpreter, scope *ScopeContext) ([]byte, error) {
...
func opGasLimit(pc *uint64, interpreter *Interpreter, scope *ScopeContext) ([]byte, error) {
	scope.Stack.push(new(uint256.Int).SetUint64(interpreter.evm.Context.GasLimit.Uint64()))
	return nil, nil
}
...
func opSuicide(pc *uint64, interpreter *Interpreter, scope *ScopeContext) ([]byte, error) {
