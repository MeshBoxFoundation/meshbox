...
import (
	...
	"github.com/MeshBoxFoundation/meshbox/accounts/keystore"
	"github.com/MeshBoxFoundation/meshbox/common"
	"github.com/MeshBoxFoundation/meshbox/consensus"
	"github.com/MeshBoxFoundation/meshbox/consensus/clique"
	"github.com/MeshBoxFoundation/meshbox/consensus/ethash"
	...
	"github.com/MeshBoxFoundation/meshbox/dashboard"
	"github.com/MeshBoxFoundation/meshbox/eth"
	"github.com/MeshBoxFoundation/meshbox/eth/downloader"
	"github.com/MeshBoxFoundation/meshbox/eth/gasprice"
	"github.com/MeshBoxFoundation/meshbox/ethdb"
	"github.com/MeshBoxFoundation/meshbox/ethstats"
	"github.com/MeshBoxFoundation/meshbox/les"
	"github.com/MeshBoxFoundation/meshbox/log"
	"github.com/MeshBoxFoundation/meshbox/metrics"
	"github.com/MeshBoxFoundation/meshbox/node"
	"github.com/MeshBoxFoundation/meshbox/p2p"
	"github.com/MeshBoxFoundation/meshbox/p2p/discover"
	"github.com/MeshBoxFoundation/meshbox/p2p/discv5"
	"github.com/MeshBoxFoundation/meshbox/p2p/nat"
	"github.com/MeshBoxFoundation/meshbox/p2p/netutil"
	"github.com/MeshBoxFoundation/meshbox/params"
	whisper "github.com/MeshBoxFoundation/meshbox/whisper/whisperv5"
...
var (
	...
	SyncModeFlag    = TextMarshalerFlag{
		Name:  "syncmode",
		Usage: `Blockchain sync mode ("full" or "light(TODO:not yet)")`,
...
func setNodeKey(ctx *cli.Context, cfg *p2p.Config) {
	/* add by liangc : disable this method
	var (
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `smc account list`)")
	log.Warn("-------------------------------------------------------------------")
...
// new format.
//
// e.g. smc account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// smc --keystore /tmp/mykeystore --lightkdf account new
//
